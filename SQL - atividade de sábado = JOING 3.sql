...
SELECT a.nome AS NomeAluno, MAX(ad.nota) AS NotaMaxima
FROM aluno a
...
SELECT d.nome AS NomeDisciplina, COUNT(ad.FK_aluno_mat) AS QtdAlunos
FROM disciplina d
...
SELECT a.nome AS NomeAluno, d.nome AS NomeDisciplina
FROM aluno a
INNER JOIN alunodisciplina ad ON a.mat = ad.FK_aluno_mat
